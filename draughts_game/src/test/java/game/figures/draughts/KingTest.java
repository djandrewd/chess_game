...
public class KingTest {
  ...
  public void testMoveToSamePosition() {
    ...
    assertTrue(king.movePath(create(1, 1), create(1, 1))
                   .isEmpty());
  }
  ...
  public void testIncorrectMoves() {
    ...
    assertTrue(king.movePath(create(1, 1), create(1, 2))
                   .isEmpty());
    assertTrue(king.movePath(create(3, 1), create(1, 2))
                   .isEmpty());
    assertTrue(king.movePath(create(0, 4), create(0, 6))
                   .isEmpty());
  }
  ...
  public void testMovingRULD() {
    ...
    assertFalse(move.isEmpty());
    assertEquals(asList(create(2, 2), create(1, 3), create(0, 4)), move);
  }
  ...
  public void testMovingRDLU() {
    ...
    assertFalse(move.isEmpty());
    assertEquals(asList(create(2, 3), create(1, 2), create(0, 1)), move);
  }
  ...
  public void testMovingLURD() {
    ...
    assertFalse(move.isEmpty());
    assertEquals(asList(create(1, 2), create(2, 3), create(3, 4)), move);
  }
  ...
  public void testMovingLDRU() {
    ...
    assertFalse(move.isEmpty());
    assertEquals(asList(create(2, 2), create(3, 1), create(4, 0)), move);
  }
