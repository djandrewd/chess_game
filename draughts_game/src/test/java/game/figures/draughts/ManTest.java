...
public class ManTest {
  ...
  public void testIncorrectMoves() {
    ...
    assertTrue(man.movePath(create(1, 1), create(1, 2))
                  .isEmpty());
    assertTrue(man.movePath(create(3, 1), create(1, 2))
                  .isEmpty());
    assertTrue(man.movePath(create(0, 4), create(0, 6))
                  .isEmpty());
    // more then allowed
    assertTrue(man.movePath(create(1, 1), create(4, 4))
                  .isEmpty());
    assertTrue(man.movePath(create(1, 2), create(4, 5))
                  .isEmpty());
  }
  ...
  public void testMovingRULD() {
    ...
    assertFalse(move.isEmpty());
    assertEquals(asList(create(2, 2), create(1, 3)), move);
  }
  ...
  public void testMovingRDLU() {
    ...
    assertFalse(move.isEmpty());
    assertEquals(asList(create(2, 3), create(1, 2)), move);
  }
  ...
  public void testMovingLURD() {
    ...
    assertFalse(move.isEmpty());
    assertEquals(asList(create(1, 2), create(2, 3)), move);
  }
  ...
  public void testMovingLDRU() {
    ...
    assertFalse(move.isEmpty());
    assertEquals(asList(create(2, 2), create(3, 1)), move);
  }
